...
newFaceid_bp = Blueprint('newFaceid', __name__)


@newFaceid_bp.route('/newFaceid', methods=['get', 'post'])
def newFaceid():
    ...
    if 'login_default_data' in session:
        if request.method == 'POST': 
            ...
            # session'dan email ve faceid verilerini al
            ...
            if len(face_location)>1:
                ...
                return render_template('newFaceid.html', scanLabel=faceidinput, img_str=img_str)
                    ...
                    for box in boxes:
                        ...
                        if conf > confidence:
                            if classNames[cls] == 'real':
                                ...
                                cv2.putText(box_face, "FAKE", (left, top - 10), font, 0.8, (0, 0, 255), 2, cv2.LINE_AA)
            ...
            # Veri tabanında bir yüz verisi yoksa:
            ...
            # veri tabanında yüz verisi var ise if yuz_oznitelik_sayac > 0:
            else :
                for x in yuz_oznitelik:
                    if x[0] == faceid:
                        yuz_oznitelik.remove(x)
                ...
                if faceid == None:
                    ...
                    # if sayac > 0 ise:
                        ...
                        print("Güncelleme Başarisiz...\nHATA: Kayıtlı yüz verisi kullanılamaz!")
                        ...
                        flash('This face already registered!', 'error')
                        flash('A registered face cannot be used!', 'warning')

                        return render_template('newFaceid.html', scanLabel=faceidinput, img_str=img_str)

                
                # if faceid != None  // kullanıcının yüz verisi var ise:
                else:
                    sayac = 0
                    ...
                    if sayac == 0:
                        ...
                        print("Kullanici başariyla face id güncelledi!")
                        #return redirect(url_for('signup_success_faceid'))
                        
                        # session['profile']['faceid'] verisini güncelle. Önemli!!
                        session['profile']['faceid'] = yuz_oznitelik_json
                        ...
                        flash('Face ID have updated successfully!', 'success')
